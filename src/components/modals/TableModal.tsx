...
import DataGridComponent from "../agGrids/DataGridComponent";
...
export type TableModalProps<T> = {
  ...
  contentMaxH?: string;
  contentMinH?: string;
} & Omit<React.ComponentProps<typeof DataGridComponent<T>>, "height">;
...
export default function TableModal<T>({
  ...
  const transparentBg = "rgb(0,0,0,0.8)"
        ...
        >
          ...
          >
            ...
            <Box
              ...
              flex="1"
            >
              <DataGridComponent {...dataGridProps} height="600px" />
            </Box>
          </MotionBox>
          {footer && (
